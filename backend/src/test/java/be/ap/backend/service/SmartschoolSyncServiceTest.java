...
// verify(restTemplate, atLeast(4)).exchange(anyString(), eq(HttpMethod.GET),
// any(), eq(Map.class));
// }
...
// assertThat(saved.getRoles()).isEqualTo(new
// HashSet<>(Set.of(UserRole.STUDENT)));
...
// .orElseThrow();
// assertThat(saved.getRoles()).isEqualTo(new
// HashSet<>(Set.of(UserRole.LEERKRACHT)));
// }
...
// List<Map<String, Object>> lastPage = List.of(buildUserPayload("sor-last",
// "legacy-last"));
...
// when(classroomRepository.save(any(Classroom.class))).thenAnswer(inv ->
// inv.getArgument(0));
...
// Map<String, Object> enrollment = buildEnrollmentPayload("enr-1", "sor-u1",
// "class-1", "student");
// stubEmptyPage("students", "users");
// stubEmptyPage("teachers", "users");
// stubEmptyPage("classes", "classes");
...
// Map<String, Object> enrollment = buildEnrollmentPayload("enr-2", "sor-t1",
// "class-1", "teacher");
// stubEmptyPage("students", "users");
// stubEmptyPage("teachers", "users");
// stubEmptyPage("classes", "classes");
...
// Map<String, Object> enrollment = buildEnrollmentPayload("enr-3", "sor-u1",
...
// // The callers treat null as "no more pages" and break, so syncSchool
// finishes
// // normally.
// when(restTemplate.exchange(anyString(), eq(HttpMethod.GET), any(),
// eq(Map.class)))
...
// .exchange(anyString(), eq(HttpMethod.GET), entityCaptor.capture(),
// eq(Map.class));
...
// private Map<String, Object> buildUserPayload(String oneRosterId, String
// legacyId) {
...
// private Map<String, Object> buildEnrollmentPayload(String id, String
// userSorId, String classSorId, String role) {
// Map<String, Object> enrollment = new HashMap<>();
