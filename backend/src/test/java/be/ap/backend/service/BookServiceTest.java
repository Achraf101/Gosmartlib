...
// Page<BookResultDTO> result = bookService.getAllBookResults(PageRequest.of(0,
// 5));
...
// BookResultDTO book = mock(BookResultDTO.class);
// when(book.getId()).thenReturn(1L);
// when(bookRepository.getAllBookResults(any())).thenReturn(new
// PageImpl<>(List.of(book)));
...
// when(bookRepository.filter(any(), any(), any(), any(), any(), isNull(),
// any(), any(), any(), any(), any(),
// any()))
// .thenReturn(Page.empty());

// bookService.filter(null, null, null, null, null, List.of(), null, null, null,
// null, null, pageable);
...
// bookService.filter(null, null, null, null, null, null, null, null, null,
// null, null, pageable);
...
// Pageable pageable = PageRequest.of(0, 10);
// when(bookRepository.filter(any(), any(), any(), any(), any(), eq(seriesIds),
// any(), any(), any(), any(), any(),
// any()))
// .thenReturn(Page.empty());

// bookService.filter(null, null, null, null, null, seriesIds, null, null, null,
// null, null, pageable);
...
// "cover_saved.jpg".equals(b.getCover())));
// }
...
// when(entityManager.find(eq(BookType.class), any())).thenReturn(new
// BookType());
// when(entityManager.find(eq(Language.class), any())).thenReturn(new
// Language());
...
// assertThrows(ResponseStatusException.class, () -> bookService.updateBook(99L,
// new UpdateBookDTO()));
// }
